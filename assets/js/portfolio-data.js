/* =========================================================================
   ...
   2. Añade un objeto a la lista PORTFOLIO con:
      ...
      file   : nombre base del archivo SIN ancho ni extensión -> "dragon-brazo"
...
window.PORTFOLIO = [
  { file: 'slot-01', name: 'Próxima pieza', cat: 'Black Work', w: 900, h: 1200, ws: [520, 720, 900], alt: 'Espacio reservado para una pieza de Black Work de Inmortal Tatts.', placeholder: true },
  ...
  { file: 'slot-04', name: 'Próxima pieza', cat: 'Black Work', w: 900, h: 1350, ws: [520, 720, 900], alt: 'Espacio reservado para una pieza de Black Work de Inmortal Tatts.', placeholder: true },
  ...
  { file: 'slot-06', name: 'Próxima pieza', cat: 'Black Work', w: 900, h: 1150, ws: [520, 720, 900], alt: 'Espacio reservado para una pieza de Black Work de Inmortal Tatts.', placeholder: true }
];
