...
window.PORTFOLIO = [
  ...
  { file: 'dragon-espalda-perfil', name: 'Dragón · de perfil', cat: 'Black & Grey', w: 900, h: 1200, ws: [520, 720, 900], alt: 'Dragón de espalda visto de perfil, con la manga floral del otro brazo.' },
  { file: 'dragon-espalda-completa', name: 'Dragón · espalda completa', cat: 'Black & Grey', w: 900, h: 1200, ws: [520, 720, 900], alt: 'Vista completa del dragón japonés tatuado en la espalda.' },
  { file: 'dragon-espalda-detalle', name: 'Dragón · detalle', cat: 'Black & Grey', w: 900, h: 1200, ws: [520, 720, 900], alt: 'Detalle de la cabeza del dragón de espalda, en negro y gris.' },
  { file: 'guerrera-azteca-detalle', name: 'Guerrera azteca · detalle', cat: 'Black & Grey', w: 819, h: 1280, ws: [520, 720, 819], alt: 'Detalle del rostro de la guerrera azteca tatuada en el hombro.' },
  { file: 'manga-religiosa-brazo', name: 'Manga religiosa · brazo completo', cat: 'Black & Grey', w: 862, h: 1280, ws: [520, 720, 862], alt: 'Vista completa de la manga religiosa desde el hombro hasta la muñeca.' },
  ...
  { file: 'criatura-color-detalle', name: 'Criatura · detalle', cat: 'Color', w: 736, h: 1280, ws: [520, 720, 736], alt: 'Detalle de la criatura ilustrada en rosas y morados tatuada en el brazo.' },
